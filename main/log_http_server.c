...
static esp_err_t http_root_get(httpd_req_t *req)
{
	static const char html[] =
		...
		"  const nodes=j.nodes||[];const serverCur=j.selected_mac;localMac=j.local_mac||localMac;const prev=s.value;let cur=serverCur||prev||selectedMac;const remembered=rememberedNode();const rememberedTag=rememberedNodeTag();\n"
		...
		"  else if(rememberedMissing){cur=remembered}\n"
