...
static esp_err_t http_root_get(httpd_req_t *req)
{
	static const char html[] =
		...
		"#top{padding:10px;background:#1b1b1b;position:sticky;top:0;z-index:5}\n"
		"#log{white-space:pre;overflow:auto;height:calc(100vh - 60px);padding:10px}\n"
		"button{margin-right:10px}\n"
		".l{margin:0;padding:0;line-height:1.25}\n"
		".lvlE{color:#ff5c57}\n"
		".lvlW{color:#f3f99d}\n"
		".lvlI{color:#5af78e}\n"
		".lvlD{color:#57c7ff}\n"
		...
		"  let m=line.match(/\\]\\s*([VDIWE])\\s*\\(/);\n"
		"  if(!m) m=line.match(/^\\s*([VDIWE])\\s*\\(/);\n"
		"  return m?m[1]:'';\n"
		"}\n"
